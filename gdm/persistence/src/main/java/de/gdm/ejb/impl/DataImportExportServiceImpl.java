...
import de.gdm.config.ProjectConfig;
import de.gdm.ejb.DataImportExportService;
		...
		try {
			...
			if (file.exists()) {
			    ...
			    while (tok.hasMoreTokens()) {
					...
					Class<? extends AbstractEntity> entityClass = (Class<? extends AbstractEntity>) Class.forName("de.gmd.entity." + entityName);
