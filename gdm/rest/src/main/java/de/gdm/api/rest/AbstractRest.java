...
import de.gdm.api.rest.response.EntityListResponse;
import de.gdm.api.rest.response.EntityResponse;
import de.gdm.api.rest.response.ResponseCode;
import de.gdm.api.rest.response.ResponseMetadata;
import de.gdm.api.rest.validation.EntityValidator;
import de.gdm.ejb.AbstractService;
import de.gdm.entity.AbstractEntity;
import de.gdm.exception.EntityNotFoundException;
