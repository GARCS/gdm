...
(function() {
	...
	angular.module('gdmApp.selfconfig', ['ngRoute','pascalprecht.translate']);
	angular.module('gdmApp.selfconfig').factory('selfconfigConnectorFactory', selfconfigConnectorFactory);
})();
